...
// class GraphAlgos extends Component{
        

// setup = (p5, parent) => {
//   var cnv = p5.createCanvas(900, 600).parent(parent);
...
//             <div styles="text-align:center" class="mt-3">   
//                 <form>
//                 <label htmlFor="rootN">Enter Root node: </label>
//                 <input type="text" id="rootN"  styles="width:100px;" onkeypress="return event.keyCode != 13" aria-required="true"/>
//                 <button type="button" onClick={input} className="btn btn-dark">BFS</button>    
//                 <button type="button" onClick={input2} className="btn btn-dark"> DFS </button>
//                 <button type="button" onClick={clearg} className="btn btn-light"> Clear Graph</button>
//                 </form>
    
//             <p id="output" class="mt-3"><h3>Draw Graph below</h3></p>
